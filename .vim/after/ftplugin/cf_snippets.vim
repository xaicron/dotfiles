...
exec "Snippet out <cfoutput>".st."foo".et."</cfoutput><CR>".st.et
exec "Snippet scr <cfscript><CR>".st."foo".et."<CR></cfscript><CR>".st.et
exec "Snippet dump <cfdump var=\"".st."foo".et."\"><CR>".st.et
